...
socket_t::accept_awaiter::accept_awaiter(context_t &ctx, int fd, sockaddr_in *addr, int flag) : utask_t(ctx) {
...
socket_t::connect_awaiter::connect_awaiter(context_t &ctx, int fd, const std::string &ip, unsigned int port) : utask_t(ctx) {
